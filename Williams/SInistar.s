...
! Script for Sinistar by Williams
...
ROM @ D000-DFFF	SIG	4caa !Joust.10B
ROM @ E000-EFFF	SIG	e5d6 !Joust.11B
ROM @ F000-FFFF	SIG	9996 !Joust.12B

!Rom banks show up at C000-CFFF if selected (ALSO C900=01 to read rom)
!Requires bank switch d000=01
!ROM @ C000-C7FF	SIG	16B9 !Joust.9
!ROM @ C800-CFFF	SIG	4404 !Joust.12

!Requires bank switch d000=02
!ROM @ C000-C7FF	SIG	FF14 !Joust.8
!ROM @ C800-CFFF	SIG	0B40 !Joust.11

!Requires bank switch d000=03
!ROM @ C000-C7FF	SIG	ADEA !Joust.7
!ROM @ C800-CFFF	SIG	A534 !Joust.10

!Requires bank switch d000=07
! Rom 5 is not loaded on this game
!ROM @ C000-C7FF	SIG	6B52 !Joust.6
!ROM @ C800-CFFF	SIG	6B52 !Joust.6
...
RomTest:
    ...
    DPY MainRoms. 1
    ROM @ D000-D7FF	SIG	2541 !Joust.1
    DPY + 4
    ROM @ D800-DFFF	SIG	BFB7 !Joust.4
    DPY + 2
    ROM @ E000-EFFF	SIG	E7CE !Joust.2
    DPY + 3
    ROM @ F000-FFFF	SIG	2013 !Joust.3
